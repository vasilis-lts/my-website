    ...
    <>
      ...
      <main className={styles.main}>
        ...
        <div className={styles.center} style={{ width: '90%', maxWidth: 500, textAlign: 'justify', alignItems: "initial", lineHeight: '1.4rem' }}>
          ...
          <p style={{ marginTop: 20 }}>I am a front end developer based in <b>Athens, Greece,</b> with 7 years of experience. I started working on websites, for my first 2 years, using <b>Wordpress</b>, then I moved to <b>React</b> apps. My previous job was working remotely at Architechts, a company based in the Netherlands.</p>
        ...
        <div style={{ marginTop: 40, width: '90%', maxWidth: 500 }} className="flex-center-y">
          <p>For additional info check out my Linked In profile! </p>
